...
auth: state,
browser: [`Jadibot Md By Kuro`, "Chrome", "1.0.0"],
...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6285607265790@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6285607265790@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `6285607265790@s.whatsapp.net`
}
}, options)
